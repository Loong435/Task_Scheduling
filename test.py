...
RL_agent.Dqn.load_state_dict(torch.load('./experiment4/resultTest/myRL_weights_global_step239500.pth'))
RL_agent.target_Dqn.load_state_dict(torch.load('./experiment4/resultTest/myRL_weights_global_step239500.pth'))
